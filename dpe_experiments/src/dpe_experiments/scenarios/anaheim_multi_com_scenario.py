...
from dpe_experiments.ml.neighboring_edges import get_neighboring_edges_undirected
...
def run_scenario(
    edges_tntp_path: str, trip_tntp_file_path: str, geojson_path: str, scenario_dir: str
):
