...
from dynflows.importer.sioux_falls_importer import add_od_pairs, import_sioux_falls
...
from dpe_experiments.ml.TFFullNetworkModel import train_tf_full_net_model
...
def run_scenario(
    ...
    demand_sigma = min(Network.from_file(network_path).capacity) / 8.0
...
if __name__ == "__main__":
    ...
    def main():
        ...
        run_scenario(
            ...
            nodes_tntp_path,
            od_pairs_csv_path,
            "./out/journal-sioux-falls-multi-com",
        )
