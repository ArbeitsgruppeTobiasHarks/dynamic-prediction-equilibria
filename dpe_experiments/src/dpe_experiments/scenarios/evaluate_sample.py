...
from dynflows.eval.evaluate import COLORS, evaluate_single_run
...
from dpe_experiments.predictors.linear_regression_predictor import (
...
def eval_sample():
    ...
    while demand <= max_demand:
        ...
        times, comp_time, flow = evaluate_single_run(
            network,
            predictor_types=[PredictorType.CONSTANT],
            flow_id=None,
