...
In this section, we will introduce another class called \code{class MultiComFlowBuilder} which takes a network including a list of commodities as defined in Data Structure~\ref{data:commodity}.
