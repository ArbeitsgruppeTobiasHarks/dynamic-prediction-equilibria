...
An implementation of this is shown in Algorithm~\ref{alg:backward-search}, where \code{arrivals} consists of the labels $(l_{s,w}(\theta))_{w\in V'}$ as returned by the Dynamic Dijkstra Algorithm.
