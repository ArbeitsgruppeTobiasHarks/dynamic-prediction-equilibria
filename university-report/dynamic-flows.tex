...
\todo[inline]{
    $s_i$ should be able to reach $t_i$. Maybe we define $V_i$ as the set of "important nodes" for commodity $i$, i.e. $V_i = \{ v \in V \mid \text{$s_i$ can reach $v$ and $v$ can reach $t_i$ in (V, E)} \}$
}
