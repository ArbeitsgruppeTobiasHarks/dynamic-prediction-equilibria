...
Consider simple network with two parallel edges on Figure \ref{fig:instance}. Let upper edge have index $0$ and lower $1$. We consider inflow $u(\theta) \leq 5 =  \nu_0 + \nu_1 $ with  two options:  $u(\theta) = 5$(max demand) and $u(\theta) = 4.5 > \nu_0$ (medium demand).
