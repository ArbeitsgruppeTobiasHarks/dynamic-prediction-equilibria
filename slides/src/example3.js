...
export const Example3Svg = ({ demo = false, svgIdPrefix = "example3-", overrideT = null, width = 1000, height = 250 + 200 + 25 }) => {
    if (typeof overrideT == 'number') {
        return <SvgContent width={width} height={height} diagramVisible={true} svgIdPrefix={svgIdPrefix} t={overrideT} mode={MODE.TIMESERIES} />
    }
    ...
    return <Stepper values={steps} alwaysVisible>
        {
            (value, step, isActive) => {
                ...
                return <SvgContent mode={demo ? MODE.DEMO : MODE.DEFAULT} width={width} height={height} diagramVisible={demo || typeof value == 'number'} svgIdPrefix={svgIdPrefix2} t={t} />
            }
        }
    </Stepper>
}
...
const SvgContent = ({ width, height, mode = MODE.DEFAULT, svgIdPrefix, t, diagramVisible }) => {
    const diagram = {
        [MODE.DEFAULT]: <QueueDiagram svgIdPrefix={svgIdPrefix} x={600} y={100} width={350} t={t} queue={flow.queues[1]} visible={diagramVisible} />,
        [MODE.DEMO]: <QueueDiagram svgIdPrefix={svgIdPrefix} x={600} y={120} width={350} t={t} queue={flow.queues[1]} visible={diagramVisible} />,
