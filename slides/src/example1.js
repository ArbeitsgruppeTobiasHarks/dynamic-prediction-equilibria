...
export const Example1Svg = ({ overrideT = null }) => {
    ...
    if (typeof overrideT == 'number') {
        return <SvgContent width={width} height={height} svgIdPrefix={svgIdPrefix} t={overrideT} showStopWatch={false} />
    }
    return <Stepper values={[0, 400, 800, 1200, 1200.00001, 1450, 1900]} alwaysVisible>
        {
            (value, step, isActive) => {
                ...
                return <SvgContent width={width} height={height} svgIdPrefix={svgIdPrefix} t={t} showStopWatch={typeof value == 'number'} />
            }
        }
    </Stepper>
}
...
const SvgContent = ({ width, height, svgIdPrefix, t, showStopWatch}) => {
    ...
    <svg width={width} height={height}>
        ...
        <g opacity={showStopWatch ? 1 : 0} style={{transition: 'opacity 0.2s'}}>
