...
from dynflows.core.dijkstra import dynamic_dijkstra, get_active_edges_from_dijkstra
...
from dynflows.utilities.status_logger import TimedStatusLogger
...
def approximate_max_predicted_delay(
    ...
    with TimedStatusLogger("Evaluating prediction accuracy eps...") as status:
        ...
        for comm_idx in range(len(network.commodities)):
            ...
            predictor = predictors[predictor_types[comm_idx]]
