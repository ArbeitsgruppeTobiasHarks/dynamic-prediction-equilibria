...
from dynflows.core.bellman_ford import bellman_ford
...
from dynflows.eval.predicted_delay import approximate_max_predicted_delay
...
def evaluate_single_run(
    ...
    combine_commodities_with_same_sink(network, predictor_types)
