...
from dynflows.core.predictors.tf_neighborhood_predictor import TFNeighborhoodPredictor
from dynflows.ml.neighboring_edges import get_neighboring_edges_mask_undirected
from dynflows.ml.QueueAndEdgeLoadsDataset import QueueAndEdgeLoadDataset
...
def train_tf_neighborhood_model(
    ...
    def build_tf_neighborhood_predictor(network: Network) -> TFNeighborhoodPredictor:
        return TFNeighborhoodPredictor.from_models(
            network,
            models_path,
            input_mask,
            output_mask,
