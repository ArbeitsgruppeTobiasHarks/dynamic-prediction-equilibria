...
class SKNeighborhoodPredictor(Predictor):
    ...
    def __init__(self, models: Dict[int, Pipeline], input_mask: np.ndarray, output_mask: np.ndarray, network: Network,
    ...
    def from_models(network: Network, models_path: str, input_mask: np.ndarray, output_mask: np.ndarray,
        ...
        return SKNeighborhoodPredictor(models, input_mask, output_mask, network, past_timesteps, future_timesteps,
