...
class TestBellmanFord(unittest.TestCase):
    def test_flow_bellman_ford(self):
        ...
        costs = [
            PiecewiseLinear(
                [2.05, 2.55, 3.55], [1.025, 1.0, 1.0], (2.05, float("inf"))
            ),
            PiecewiseLinear(
                [2.05, 2.55, 3.55], [3.075, 3.7, 3.7], (2.05, float("inf"))
            ),
            PiecewiseLinear([2.05, 2.55, 3.55], [1.0, 1.0, 1.0], (2.05, float("inf"))),
            PiecewiseLinear([2.05, 2.55, 3.55], [1.0, 1.0, 1.0], (2.05, float("inf"))),
            PiecewiseLinear(
                [2.05, 2.55, 3.55], [1.05, 1.55, 1.55], (2.05, float("inf"))
            ),
        ]
        phi = 2.075
