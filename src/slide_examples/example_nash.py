...
def build_example_nash():
    ...
    e4 = network.add_edge(1, 2, 200, 10)
    e5 = network.add_edge(2, 4, 200, 10)
    ...
    loader = NetworkLoader(network, [
        ([e1, e2, e3], RightConstant([0, 200, 800], [20, 10, 0], (0, float('inf')))),
        ([e1, e4, e5], RightConstant([0, 200, 800], [0, 10, 0], (0, float('inf'))))
    ])
    ...
    to_visualization_json("./exampleNash.vis.json", flow, network, color_by_comm_idx)
