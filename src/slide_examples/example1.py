...
def build_example1():
    ...
    network.add_commodity({0: RightConstant([0, 400, 600, 1200, 1300], [10, 20, 0, 20, 0], domain=(0, float('inf')))}, 2, PredictorType.ZERO)
    network.add_commodity({3: RightConstant([0, 1200, 1300], [0, 10, 0], domain=(0, float('inf')))}, 2, PredictorType.ZERO)
